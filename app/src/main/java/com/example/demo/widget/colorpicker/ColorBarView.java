 ...
 * on 2021/2/1 5:12 PM.
 * 基于hsv模型seekBar
 * https://github.com/DonTiny/ColorPickDemo
 */

public class ColorBarView extends View {
    public static final int PAINT_STROKE_WIDTH = 6;    //外心圆画笔宽度
    private float selectorRadiusPx = 25;
    ...
    public interface OnColorChangeListener {
        void onColorChange(int color, boolean isTouchUp);
    }
    ...
    private void init() {
        ...
        selectorPaint.setColor(0xffb1aaa0);
    ...
    private void initCustomAttrs(Context context, AttributeSet attrs) {
        ...
        if (typedArray != null) {
            barHeight = typedArray.getDimension(R.styleable.ColorBarView_cbBarHeight, 30);
            thumbHeight = typedArray.getDimension(R.styleable.ColorBarView_cbThumbHeight, 80);
            typedArray.recycle();
        }
    }
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        if (onColorChangeListener != null) {
            onColorChangeListener.onColorChange(currentColor, isTouchUp);
        }
//        BHLog.d("ColorBarView", "event:" + event.getAction());
        selectorRadiusPx = isTouchUp ? 25 : 35;
        invalidate();
        return true;
    }
...
//        }
    ...
    private void drawThumb(Canvas canvas) {
        ...
        currentThumbOffset = position + thumbWidth / 2;
        RectF rectF = getThumbRect();
        changePaint.setColor(currentColor);
        selectorPaint.setShadowLayer(8f, 0f, 0f, Color.GRAY);
        canvas.drawCircle(rectF.centerX(), rectF.centerY(), selectorRadiusPx, selectorPaint);
        canvas.drawCircle(rectF.centerX(), rectF.centerY(), selectorRadiusPx - PAINT_STROKE_WIDTH / 2, changePaint);
    }
