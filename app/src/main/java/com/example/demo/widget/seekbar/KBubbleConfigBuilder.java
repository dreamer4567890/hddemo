...
public class KBubbleConfigBuilder {
    ...
    public KBubbleConfigBuilder(KBubbleSeekBar bubbleSeekBar) {
    ...
    public KBubbleConfigBuilder trackSize(int dp) {
        this.trackSize = ScreenUtils.dpToPx(dp);
        return this;
    }

    public KBubbleConfigBuilder secondTrackSize(int dp) {
        this.secondTrackSize = ScreenUtils.dpToPx(dp);
        return this;
    }

    public KBubbleConfigBuilder thumbRadius(int dp) {
        this.thumbRadius = ScreenUtils.dpToPx(dp);
        return this;
    }

    public KBubbleConfigBuilder thumbRadiusOnDragging(int dp) {
        this.thumbRadiusOnDragging =ScreenUtils.dpToPx(dp);
        return this;
    }
    ...
    public KBubbleConfigBuilder sectionTextSize(int sp) {
        this.sectionTextSize = ScreenUtils.spToPx(sp);
        return this;
    }
    ...
    public KBubbleConfigBuilder thumbTextSize(int sp) {
        this.thumbTextSize = ScreenUtils.spToPx(sp);
        return this;
    }
    ...
    public KBubbleConfigBuilder bubbleTextSize(int sp) {
        this.bubbleTextSize = ScreenUtils.spToPx(sp);
        return this;
    }
