...
public class ViewHolder extends RecyclerView.ViewHolder {
    ...
    public ViewHolder setText(int viewId, @StringRes int text) {
        TextView tv = getView(viewId);
        tv.setText(mContext.getString(text));
        return this;
    }
    ...
    public ViewHolder setTextPadding(int viewId, int left, int top, int right, int bottom) {
        TextView view = getView(viewId);
    ...
    public ViewHolder setSelect(int viewId, boolean enable) {
        View view = getView(viewId);
