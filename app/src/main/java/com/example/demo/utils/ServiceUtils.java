...
public final class ServiceUtils {
    ...
    public static Set getAllRunningService() {
        ActivityManager am =
                (ActivityManager) AppTrace.getContext().getSystemService(Context.ACTIVITY_SERVICE);
    ...
    public static void startService(final Class<?> cls) {
        Intent intent = new Intent(AppTrace.getContext(), cls);
        AppTrace.getContext().startService(intent);
    }
    ...
    public static boolean stopService(final Class<?> cls) {
        Intent intent = new Intent(AppTrace.getContext(), cls);
        return AppTrace.getContext().stopService(intent);
    }
    ...
    public static void bindService(final Class<?> cls,
                                   ...
                                   final int flags) {
        Intent intent = new Intent(AppTrace.getContext(), cls);
        AppTrace.getContext().bindService(intent, conn, flags);
    }
    ...
    public static void unbindService(final ServiceConnection conn) {
        AppTrace.getContext().unbindService(conn);
    }
