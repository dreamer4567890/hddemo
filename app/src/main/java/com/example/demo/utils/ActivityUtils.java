...
public final class ActivityUtils {
    ...
    public static boolean isActivityExists(@NonNull final String packageName,
        ...
        return !(AppTrace.getContext().getPackageManager().resolveActivity(intent, 0) == null ||
                intent.resolveActivity(AppTrace.getContext().getPackageManager()) == null ||
                AppTrace.getContext().getPackageManager().queryIntentActivities(intent, 0).size() == 0);
    }
    ...
    public static List<Activity> getActivityList() {
        return AppVisibleMonitor.sActivityList;
    }
    ...
    public static String getLauncherActivity() {
        return getLauncherActivity(AppTrace.getContext().getPackageName());
    }
    ...
    public static String getLauncherActivity(@NonNull final String packageName) {
        ...
        PackageManager pm = AppTrace.getContext().getPackageManager();
    ...
    public static Activity getTopActivity() {
        if (AppVisibleMonitor.mTopVisibleActivity != null) {
            Activity activity = AppVisibleMonitor.mTopVisibleActivity.get();
            if (activity != null) {
                return activity;
            }
        }
        List<Activity> activities = AppVisibleMonitor.sActivityList;
    ...
    public static void finishAllActivities(final boolean isLoadAnim) {
        List<Activity> activityList = AppVisibleMonitor.sActivityList;
    ...
    /**
     * 结束除home之外的所有 Activity
     */
    public static void finishAllActivitiesExceptHome() {
        finishAllActivitiesExceptHome(false);
    }
     ...
     * @param isLoadAnim 是否启动动画
     */
    public static void finishAllActivitiesExceptHome(final boolean isLoadAnim) {
        List<Activity> activities = AppVisibleMonitor.sActivityList;
        boolean flag = false;
    ...
    private static Context getActivityOrApp() {
        ...
        return topActivity == null ? AppTrace.getContext() : topActivity;
    }
